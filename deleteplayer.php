...
<br>
delete coach: <?php echo $_POST["deletePlayer"]; ?> <br>

 
     <?php
     
     
     if(!($stmt = $mysqli->prepare("DELETE FROM PLAYER WHERE player_id = ?")))
     {
     ...
     {
     echo "deleted " . $stmt->affected_rows . " rows (player) from PLAYER.";
     }
